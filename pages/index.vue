<template>
  <section class="container rel">
    <div id="orb" class="my-auto"></div>
    <div id="waves"></div>
    <div class="flex align-center">
      <h1 id="job-title" class="blue-1">Front End <br>Developer</h1>
    </div>
  </section>
</template>
    ...
    head () {
      return {
          ...
          meta: [
              ...
              { hid: 'description', name: 'description', content: 'Nick Rosen Portfolio Home Page' }
          ]
      }
    }
  }
