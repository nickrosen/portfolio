  ...
  <section class="grey-1 container flex row wrap">
    ...
    <div class="content-area mt-24">
      <div class="border-y mb-24">
        <h2 class="headline">Philosophy</h2>
      </div>
    ...
    head () {
      return {
          ...
          meta: [
              ...
              { hid: 'description', name: 'description', content: 'Nick Rosen Portfolio Learning Page' }
          ]
      }
    }
  }
